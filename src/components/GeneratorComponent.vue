  ...
  <Card class="training-generator">
    <template #title>
      ...
      <InfoComponent title="Hoe werkt het?">
        ...
        gebruikt worden om een training specifieker te maken. De sliders zijn om
        het aantal minuten van de oefeningen te beïnvloeden.
      </InfoComponent>
    </template>
    <template #content>
      <div class="p-d-flex">
...
<script setup lang="ts">
  ...
  function generateTraining() {
    ...
    generatedTraining.value = exercises
  }
